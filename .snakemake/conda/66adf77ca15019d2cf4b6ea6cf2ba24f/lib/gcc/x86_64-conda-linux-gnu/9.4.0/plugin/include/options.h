...
enum opt_code
{
  ...
  OPT_m128bit_long_double = 1274,            /* -m128bit-long-double */
  OPT_m16 = 1275,                            /* -m16 */
  OPT_m32 = 1276,                            /* -m32 */
  OPT_m3dnow = 1277,                         /* -m3dnow */
  OPT_m3dnowa = 1278,                        /* -m3dnowa */
  OPT_m64 = 1279,                            /* -m64 */
  OPT_m80387 = 1280,                         /* -m80387 */
  OPT_m8bit_idiv = 1281,                     /* -m8bit-idiv */
  OPT_m96bit_long_double = 1282,             /* -m96bit-long-double */
  OPT_mabi_ = 1283,                          /* -mabi= */
  OPT_mabm = 1284,                           /* -mabm */
  OPT_maccumulate_outgoing_args = 1285,      /* -maccumulate-outgoing-args */
  OPT_maddress_mode_ = 1286,                 /* -maddress-mode= */
  OPT_madx = 1287,                           /* -madx */
  OPT_maes = 1288,                           /* -maes */
  OPT_malign_data_ = 1289,                   /* -malign-data= */
  OPT_malign_double = 1290,                  /* -malign-double */
  OPT_malign_functions_ = 1291,              /* -malign-functions= */
  OPT_malign_jumps_ = 1292,                  /* -malign-jumps= */
  OPT_malign_loops_ = 1293,                  /* -malign-loops= */
  OPT_malign_stringops = 1294,               /* -malign-stringops */
  OPT_mandroid = 1295,                       /* -mandroid */
  OPT_march_ = 1296,                         /* -march= */
  OPT_masm_ = 1297,                          /* -masm= */
  OPT_mavx = 1298,                           /* -mavx */
  OPT_mavx2 = 1299,                          /* -mavx2 */
  OPT_mavx256_split_unaligned_load = 1300,   /* -mavx256-split-unaligned-load */
  OPT_mavx256_split_unaligned_store = 1301,  /* -mavx256-split-unaligned-store */
  OPT_mavx5124fmaps = 1302,                  /* -mavx5124fmaps */
  OPT_mavx5124vnniw = 1303,                  /* -mavx5124vnniw */
  OPT_mavx512bitalg = 1304,                  /* -mavx512bitalg */
  OPT_mavx512bw = 1305,                      /* -mavx512bw */
  OPT_mavx512cd = 1306,                      /* -mavx512cd */
  OPT_mavx512dq = 1307,                      /* -mavx512dq */
  OPT_mavx512er = 1308,                      /* -mavx512er */
  OPT_mavx512f = 1309,                       /* -mavx512f */
  OPT_mavx512ifma = 1310,                    /* -mavx512ifma */
  OPT_mavx512pf = 1311,                      /* -mavx512pf */
  OPT_mavx512vbmi = 1312,                    /* -mavx512vbmi */
  OPT_mavx512vbmi2 = 1313,                   /* -mavx512vbmi2 */
  OPT_mavx512vl = 1314,                      /* -mavx512vl */
  OPT_mavx512vnni = 1315,                    /* -mavx512vnni */
  OPT_mavx512vpopcntdq = 1316,               /* -mavx512vpopcntdq */
  OPT_mbionic = 1317,                        /* -mbionic */
  OPT_mbmi = 1318,                           /* -mbmi */
  OPT_mbmi2 = 1319,                          /* -mbmi2 */
  OPT_mbranch_cost_ = 1320,                  /* -mbranch-cost= */
  OPT_mcall_ms2sysv_xlogues = 1321,          /* -mcall-ms2sysv-xlogues */
  OPT_mcet_switch = 1322,                    /* -mcet-switch */
  OPT_mcld = 1323,                           /* -mcld */
  OPT_mcldemote = 1324,                      /* -mcldemote */
  OPT_mclflushopt = 1325,                    /* -mclflushopt */
  OPT_mclwb = 1326,                          /* -mclwb */
  OPT_mclzero = 1327,                        /* -mclzero */
  OPT_mcmodel_ = 1328,                       /* -mcmodel= */
  /* OPT_mcpu_ = 1329, */                    /* -mcpu= */
  OPT_mcrc32 = 1330,                         /* -mcrc32 */
  OPT_mcx16 = 1331,                          /* -mcx16 */
  OPT_mdispatch_scheduler = 1332,            /* -mdispatch-scheduler */
  OPT_mdump_tune_features = 1333,            /* -mdump-tune-features */
  OPT_mf16c = 1334,                          /* -mf16c */
  OPT_mfancy_math_387 = 1335,                /* -mfancy-math-387 */
  OPT_mfentry = 1336,                        /* -mfentry */
  OPT_mfentry_name_ = 1337,                  /* -mfentry-name= */
  OPT_mfentry_section_ = 1338,               /* -mfentry-section= */
  OPT_mfma = 1339,                           /* -mfma */
  OPT_mfma4 = 1340,                          /* -mfma4 */
  OPT_mforce_drap = 1341,                    /* -mforce-drap */
  OPT_mforce_indirect_call = 1342,           /* -mforce-indirect-call */
  OPT_mfp_ret_in_387 = 1343,                 /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 1344,                       /* -mfpmath= */
  OPT_mfsgsbase = 1345,                      /* -mfsgsbase */
  OPT_mfunction_return_ = 1346,              /* -mfunction-return= */
  /* OPT_mfused_madd = 1347, */              /* -mfused-madd */
  OPT_mfxsr = 1348,                          /* -mfxsr */
  OPT_mgeneral_regs_only = 1349,             /* -mgeneral-regs-only */
  OPT_mgfni = 1350,                          /* -mgfni */
  OPT_mglibc = 1351,                         /* -mglibc */
  OPT_mhard_float = 1352,                    /* -mhard-float */
  OPT_mhle = 1353,                           /* -mhle */
  OPT_miamcu = 1354,                         /* -miamcu */
  OPT_mieee_fp = 1355,                       /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 1356,      /* -mincoming-stack-boundary= */
  OPT_mindirect_branch_register = 1357,      /* -mindirect-branch-register */
  OPT_mindirect_branch_ = 1358,              /* -mindirect-branch= */
  OPT_minline_all_stringops = 1359,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 1360,  /* -minline-stringops-dynamically */
  OPT_minstrument_return_ = 1361,            /* -minstrument-return= */
  /* OPT_mintel_syntax = 1362, */            /* -mintel-syntax */
  OPT_mlarge_data_threshold_ = 1363,         /* -mlarge-data-threshold= */
  OPT_mlong_double_128 = 1364,               /* -mlong-double-128 */
  OPT_mlong_double_64 = 1365,                /* -mlong-double-64 */
  OPT_mlong_double_80 = 1366,                /* -mlong-double-80 */
  OPT_mlwp = 1367,                           /* -mlwp */
  OPT_mlzcnt = 1368,                         /* -mlzcnt */
  OPT_mmanual_endbr = 1369,                  /* -mmanual-endbr */
  OPT_mmemcpy_strategy_ = 1370,              /* -mmemcpy-strategy= */
  OPT_mmemset_strategy_ = 1371,              /* -mmemset-strategy= */
  OPT_mmitigate_rop = 1372,                  /* -mmitigate-rop */
  OPT_mmmx = 1373,                           /* -mmmx */
  OPT_mmovbe = 1374,                         /* -mmovbe */
  OPT_mmovdir64b = 1375,                     /* -mmovdir64b */
  OPT_mmovdiri = 1376,                       /* -mmovdiri */
  OPT_mmpx = 1377,                           /* -mmpx */
  OPT_mms_bitfields = 1378,                  /* -mms-bitfields */
  OPT_mmusl = 1379,                          /* -mmusl */
  OPT_mmwaitx = 1380,                        /* -mmwaitx */
  OPT_mno_align_stringops = 1381,            /* -mno-align-stringops */
  OPT_mno_default = 1382,                    /* -mno-default */
  OPT_mno_fancy_math_387 = 1383,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 1384,                  /* -mno-push-args */
  OPT_mno_red_zone = 1385,                   /* -mno-red-zone */
  OPT_mno_sse4 = 1386,                       /* -mno-sse4 */
  OPT_mnop_mcount = 1387,                    /* -mnop-mcount */
  OPT_momit_leaf_frame_pointer = 1388,       /* -momit-leaf-frame-pointer */
  OPT_mpc32 = 1389,                          /* -mpc32 */
  OPT_mpc64 = 1390,                          /* -mpc64 */
  OPT_mpc80 = 1391,                          /* -mpc80 */
  OPT_mpclmul = 1392,                        /* -mpclmul */
  OPT_mpcommit = 1393,                       /* -mpcommit */
  OPT_mpconfig = 1394,                       /* -mpconfig */
  OPT_mpku = 1395,                           /* -mpku */
  OPT_mpopcnt = 1396,                        /* -mpopcnt */
  /* OPT_mprefer_avx128 = 1397, */           /* -mprefer-avx128 */
  OPT_mprefer_vector_width_ = 1398,          /* -mprefer-vector-width= */
  OPT_mpreferred_stack_boundary_ = 1399,     /* -mpreferred-stack-boundary= */
  OPT_mprefetchwt1 = 1400,                   /* -mprefetchwt1 */
  OPT_mprfchw = 1401,                        /* -mprfchw */
  OPT_mptwrite = 1402,                       /* -mptwrite */
  OPT_mpush_args = 1403,                     /* -mpush-args */
  OPT_mrdpid = 1404,                         /* -mrdpid */
  OPT_mrdrnd = 1405,                         /* -mrdrnd */
  OPT_mrdseed = 1406,                        /* -mrdseed */
  OPT_mrecip = 1407,                         /* -mrecip */
  OPT_mrecip_ = 1408,                        /* -mrecip= */
  OPT_mrecord_mcount = 1409,                 /* -mrecord-mcount */
  OPT_mrecord_return = 1410,                 /* -mrecord-return */
  OPT_mred_zone = 1411,                      /* -mred-zone */
  OPT_mregparm_ = 1412,                      /* -mregparm= */
  OPT_mrtd = 1413,                           /* -mrtd */
  OPT_mrtm = 1414,                           /* -mrtm */
  OPT_msahf = 1415,                          /* -msahf */
  OPT_msgx = 1416,                           /* -msgx */
  OPT_msha = 1417,                           /* -msha */
  OPT_mshstk = 1418,                         /* -mshstk */
  OPT_mskip_rax_setup = 1419,                /* -mskip-rax-setup */
  OPT_msoft_float = 1420,                    /* -msoft-float */
  OPT_msse = 1421,                           /* -msse */
  OPT_msse2 = 1422,                          /* -msse2 */
  OPT_msse2avx = 1423,                       /* -msse2avx */
  OPT_msse3 = 1424,                          /* -msse3 */
  OPT_msse4 = 1425,                          /* -msse4 */
  OPT_msse4_1 = 1426,                        /* -msse4.1 */
  OPT_msse4_2 = 1427,                        /* -msse4.2 */
  OPT_msse4a = 1428,                         /* -msse4a */
  /* OPT_msse5 = 1429, */                    /* -msse5 */
  OPT_msseregparm = 1430,                    /* -msseregparm */
  OPT_mssse3 = 1431,                         /* -mssse3 */
  OPT_mstack_arg_probe = 1432,               /* -mstack-arg-probe */
  OPT_mstack_protector_guard_offset_ = 1433, /* -mstack-protector-guard-offset= */
  OPT_mstack_protector_guard_reg_ = 1434,    /* -mstack-protector-guard-reg= */
  OPT_mstack_protector_guard_symbol_ = 1435, /* -mstack-protector-guard-symbol= */
  OPT_mstack_protector_guard_ = 1436,        /* -mstack-protector-guard= */
  OPT_mstackrealign = 1437,                  /* -mstackrealign */
  OPT_mstringop_strategy_ = 1438,            /* -mstringop-strategy= */
  OPT_mstv = 1439,                           /* -mstv */
  OPT_mtbm = 1440,                           /* -mtbm */
  OPT_mtls_dialect_ = 1441,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 1442,           /* -mtls-direct-seg-refs */
  OPT_mtune_ctrl_ = 1443,                    /* -mtune-ctrl= */
  OPT_mtune_ = 1444,                         /* -mtune= */
  OPT_muclibc = 1445,                        /* -muclibc */
  OPT_mvaes = 1446,                          /* -mvaes */
  OPT_mveclibabi_ = 1447,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1448,              /* -mvect8-ret-in-mem */
  OPT_mvpclmulqdq = 1449,                    /* -mvpclmulqdq */
  OPT_mvzeroupper = 1450,                    /* -mvzeroupper */
  OPT_mwaitpkg = 1451,                       /* -mwaitpkg */
  OPT_mwbnoinvd = 1452,                      /* -mwbnoinvd */
  OPT_mx32 = 1453,                           /* -mx32 */
  OPT_mxop = 1454,                           /* -mxop */
  OPT_mxsave = 1455,                         /* -mxsave */
  OPT_mxsavec = 1456,                        /* -mxsavec */
  OPT_mxsaveopt = 1457,                      /* -mxsaveopt */
  OPT_mxsaves = 1458,                        /* -mxsaves */
  OPT_n = 1459,                              /* -n */
  OPT_no_canonical_prefixes = 1460,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1461,              /* -no-integrated-cpp */
  OPT_no_pie = 1462,                         /* -no-pie */
  OPT_nocpp = 1463,                          /* -nocpp */
  OPT_nodefaultlibs = 1464,                  /* -nodefaultlibs */
  OPT_nolibc = 1465,                         /* -nolibc */
  OPT_nophoboslib = 1466,                    /* -nophoboslib */
  OPT_nostartfiles = 1467,                   /* -nostartfiles */
  OPT_nostdinc = 1468,                       /* -nostdinc */
  OPT_nostdinc__ = 1469,                     /* -nostdinc++ */
  OPT_nostdlib = 1470,                       /* -nostdlib */
  OPT_o = 1471,                              /* -o */
  OPT_p = 1472,                              /* -p */
  OPT_pass_exit_codes = 1473,                /* -pass-exit-codes */
  /* OPT_pedantic = 1474, */                 /* -pedantic */
  OPT_pedantic_errors = 1475,                /* -pedantic-errors */
  OPT_pg = 1476,                             /* -pg */
  OPT_pie = 1477,                            /* -pie */
  OPT_pipe = 1478,                           /* -pipe */
  OPT_posix = 1479,                          /* -posix */
  OPT_print_file_name_ = 1480,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1481,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1482,          /* -print-multi-directory */
  OPT_print_multi_lib = 1483,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1484,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1485,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1486,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1487,               /* -print-prog-name= */
  OPT_print_search_dirs = 1488,              /* -print-search-dirs */
  OPT_print_sysroot = 1489,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1490,   /* -print-sysroot-headers-suffix */
  OPT_profile = 1491,                        /* -profile */
  OPT_pthread = 1492,                        /* -pthread */
  OPT_quiet = 1493,                          /* -quiet */
  OPT_r = 1494,                              /* -r */
  OPT_rdynamic = 1495,                       /* -rdynamic */
  OPT_remap = 1496,                          /* -remap */
  OPT_s = 1497,                              /* -s */
  OPT_save_temps = 1498,                     /* -save-temps */
  OPT_save_temps_ = 1499,                    /* -save-temps= */
  OPT_shared = 1500,                         /* -shared */
  OPT_shared_libgcc = 1501,                  /* -shared-libgcc */
  OPT_shared_libphobos = 1502,               /* -shared-libphobos */
  /* OPT_specs = 1503, */                    /* -specs */
  OPT_specs_ = 1504,                         /* -specs= */
  OPT_static = 1505,                         /* -static */
  OPT_static_libasan = 1506,                 /* -static-libasan */
  OPT_static_libgcc = 1507,                  /* -static-libgcc */
  OPT_static_libgfortran = 1508,             /* -static-libgfortran */
  OPT_static_libgo = 1509,                   /* -static-libgo */
  OPT_static_liblsan = 1510,                 /* -static-liblsan */
  OPT_static_libmpx = 1511,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1512,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 1513,               /* -static-libphobos */
  OPT_static_libstdc__ = 1514,               /* -static-libstdc++ */
  OPT_static_libtsan = 1515,                 /* -static-libtsan */
  OPT_static_libubsan = 1516,                /* -static-libubsan */
  OPT_static_pie = 1517,                     /* -static-pie */
  /* OPT_std_c__03 = 1518, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1519, */                /* -std=c++0x */
  OPT_std_c__11 = 1520,                      /* -std=c++11 */
  OPT_std_c__14 = 1521,                      /* -std=c++14 */
  OPT_std_c__17 = 1522,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1523, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1524, */                /* -std=c++1z */
  OPT_std_c__2a = 1525,                      /* -std=c++2a */
  OPT_std_c__98 = 1526,                      /* -std=c++98 */
  OPT_std_c11 = 1527,                        /* -std=c11 */
  OPT_std_c17 = 1528,                        /* -std=c17 */
  /* OPT_std_c18 = 1529, */                  /* -std=c18 */
  /* OPT_std_c1x = 1530, */                  /* -std=c1x */
  OPT_std_c2x = 1531,                        /* -std=c2x */
  /* OPT_std_c89 = 1532, */                  /* -std=c89 */
  OPT_std_c90 = 1533,                        /* -std=c90 */
  OPT_std_c99 = 1534,                        /* -std=c99 */
  /* OPT_std_c9x = 1535, */                  /* -std=c9x */
  OPT_std_f2003 = 1536,                      /* -std=f2003 */
  OPT_std_f2008 = 1537,                      /* -std=f2008 */
  OPT_std_f2008ts = 1538,                    /* -std=f2008ts */
  OPT_std_f2018 = 1539,                      /* -std=f2018 */
  OPT_std_f95 = 1540,                        /* -std=f95 */
  OPT_std_gnu = 1541,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1542, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1543, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1544,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1545,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1546,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1547, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1548, */              /* -std=gnu++1z */
  OPT_std_gnu__2a = 1549,                    /* -std=gnu++2a */
  OPT_std_gnu__98 = 1550,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1551,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1552,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1553, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1554, */                /* -std=gnu1x */
  OPT_std_gnu2x = 1555,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 1556, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1557,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1558,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1559, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1560, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1561,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1562, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1563, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1564, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1565, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1566, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1567,                     /* -std=legacy */
  OPT_symbolic = 1568,                       /* -symbolic */
  OPT_t = 1569,                              /* -t */
  OPT_time = 1570,                           /* -time */
  OPT_time_ = 1571,                          /* -time= */
  OPT_tno_android_cc = 1572,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1573,                 /* -tno-android-ld */
  OPT_traditional = 1574,                    /* -traditional */
  OPT_traditional_cpp = 1575,                /* -traditional-cpp */
  OPT_trigraphs = 1576,                      /* -trigraphs */
  OPT_u = 1577,                              /* -u */
  OPT_undef = 1578,                          /* -undef */
  OPT_v = 1579,                              /* -v */
  OPT_version = 1580,                        /* -version */
  OPT_w = 1581,                              /* -w */
  OPT_wrapper = 1582,                        /* -wrapper */
  OPT_x = 1583,                              /* -x */
  OPT_z = 1584,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
